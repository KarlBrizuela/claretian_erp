<x-app-layout :title="$title" :role="$role" :sidebar="$sidebar">
                ...
                <form action="{{ route('admin-finance.check-voucher.store') }}" method="POST">
                    ...
                    <table class="voucher-table">
                        ...
                        <tbody id="voucherTableBody">
                            <tr>
                                <td>
                                    <input type="text" class="form-control border-0" name="items[0][account_name]" placeholder="Enter account name" required>
                                </td>
    ...
    <script>
        function calculateTotals() {
            ...
            // Sync with hidden field (using the larger of the two if they aren't balanced, 
            // though accounting logic usually requires balance)
        ...
        function addRow() {
            ...
            row.innerHTML = `
                <td><input type="text" class="form-control border-0" name="items[${index}][account_name]" placeholder="Enter account name" required></td>
