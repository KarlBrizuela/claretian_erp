...
<nav class="modern-nav-menu">
	...
	<div class="modern-nav-group {{ request()->is('production/logistic*') ? 'active' : '' }}">
		...
		<div class="modern-nav-submenu" data-submenu="logistics">
			...
			<a href="{{ route('production.logistic.freight-quotation') }}" class="modern-nav-subitem {{ request()->routeIs('production.logistic.freight-quotation') ? 'active' : '' }}">Freight Quotation</a>
