<x-app-layout :title="'Acknowledgement Receipt'" :sidebar="'production'">
                    ...
                    <div class="table-responsive">
                        <table id="ackTable" class="display" style="width:100%">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="workflow-actions">
                                            ...
                                            <a href="#" class="btn btn-success shadow btn-xs sharp"
                                               title="Import Excel (Customer Name + Pick Qty)"
                                               data-bs-toggle="modal" data-bs-target="#importModal{{ $order->id }}">
                                ...
                                @empty
                                <tr>
                                    <td colspan="8" class="text-center">No Area Sales Consignment orders found.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content so-modal-form">
                <form method="POST" action="{{ route('production.logistic.acknowledgement-receipt.import') }}">
                    ...
                    <div class="modal-footer" style="border-top:2px solid #e0e0e0;">
    ...
    {{-- ── Import Excel Modal ── --}}
    <div class="modal fade" id="importModal{{ $order->id }}" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('production.logistic.acknowledgement-receipt.import-excel') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="order_id" value="{{ $order->id }}">
                    <div class="modal-header">
                        <h5 class="modal-title">
                            <i class="las la-file-excel me-2 text-success"></i>
                            Import Excel — <strong>{{ $order->so_number }}</strong>
                        </h5>
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info mb-3" style="font-size:0.85rem;">
                            ...
                            <ol class="mb-0 mt-1 ps-3">
                                <li>Export <strong>{{ $order->so_number }}</strong> from Marketing → Sales Orders.</li>
                                <li>Open the Excel. Fill <strong style="color:#1a5276;">Row 7 Col B</strong> with the <strong>Customer Name</strong>.</li>
                                <li>Fill <strong style="color:#cc7000;">Column G</strong> with <strong>Pick Qty</strong> per item.</li>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Only .xlsx / .xls — must be the export of <strong>{{ $order->so_number }}</strong>.</small>
                        </div>
                    </div>
