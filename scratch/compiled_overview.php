                                          ...
                                          <div class="table-responsive">
                                              <table class="table table-bordered table-responsive-md text-black align-middle">
                                                  ...
                                                  <tbody>
                                                      ...
                                                      <tr>
                                                          <td colspan="<?php echo e(count($sites) + 4); ?>" class="text-center py-4 text-muted">No items found in master registry.</td>
                                                      </tr>
                                                      <?php endif; ?>
                                                  </tbody>
                                              </table>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        window.initTransferModalFromMaster = function() {
            if (typeof selectedBooksMap !== 'undefined') selectedBooksMap = {};
            if (typeof nextRowId !== 'undefined') nextRowId = 1;
            if (typeof siteBooks !== 'undefined') siteBooks = {};
            
            const fromSelect = document.getElementById('fromSiteSelect');
            const toSelect = document.getElementById('toSiteSelect');
            if (fromSelect) {
                fromSelect.value = '';
                if (window.jQuery) $(fromSelect).trigger('change');
            }
            if (toSelect) {
                toSelect.value = '';
                if (window.jQuery) $(toSelect).trigger('change');
            }
            ...
            if (typeof renderSelectedBooks === 'function') renderSelectedBooks();
